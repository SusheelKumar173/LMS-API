...
export default class ManagerUpdatePassword extends Component {
...
else if(this.state.password.length <4)
{
  ...
  //  https://localhost:44370/api/Manager/UpdatePassword/ram12%40gmail.com
else{
let url="https://localhost:44370/api/Manager/UpdatePassword/"+user.emailId;
axios.put(url,{
